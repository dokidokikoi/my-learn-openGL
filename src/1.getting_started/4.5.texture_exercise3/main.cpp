...
int main()
{
    ...
    Shader ourShader("src/1.getting_started/4.5.texture_exercise3/shader.vs", "src/1.getting_started/4.5.texture_exercise3/shader.fs");

    // 顶点
    float vertices[] = {
       0.5f, 0.5f, 0.0f, 1.0f, 0.0f, 0.0f, 0.55f, 0.55f,
       0.5f, -0.5f, 0.0f, 0.0, 1.0f, 0.0f, 0.55f, 0.45f,
       -0.5f, -0.5f, 0.0f, 0.0, 0.0f, 1.0f, 0.45f, 0.55f,
